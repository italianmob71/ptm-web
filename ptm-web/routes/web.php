...
Route::get('/studies/get-involved-in-research', [GetInvolvedInResearchController::class, 'index'])->name('get-involved');
Route::get('/studies/renewed-covenant', [RenewedCovenantController::class, 'index'])->name('renewed-covenant');
Route::get('/studies/special-studies', [SpecialStudiesController::class, 'index'])->name('special-studies');
